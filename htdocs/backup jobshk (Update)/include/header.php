	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            if( isset($_SESSION['email'])==true){ ?>
              ...
              <li class="nav-item">
              <div class="dropdown">
              <img src="profile_img/<?php if(empty($img)){echo "login_iconbbc.png";}else{echo $img;} ?>" class="img-circle dropdown-toggle" type="button" data-toggle="dropdown" alt="Cinque Terre" width="50" height="50">
	          ...
	          <li class="nav-item cta mr-md-2"><a href="job-post.php" class="nav-link">Sign Up</a></li>
            <li class="nav-item mr-md-2 btn btn-outline-primary"><a href="job-post.php" class="nav-link">For Employers</a></li>
            <?php
            }
            ?>
