...
if($keyword==""){
 $sql=mysqli_query($conn,"select * from all_jobs LEFT JOIN company ON all_jobs.customer_email=company.admin WHERE category='$category' ORDER BY job_id DESC limit $page1,3");}
 else{$sql=mysqli_query($conn,"select * from all_jobs LEFT JOIN company ON all_jobs.customer_email=company.admin WHERE keyword LIKE '%$keyword%' OR category='$category' ORDER BY job_id DESC limit $page1,3");}
  $error=mysqli_num_rows($sql);

  if($category==""){
    $sql=mysqli_query($conn,"select * from all_jobs LEFT JOIN company ON all_jobs.customer_email=company.admin WHERE keyword LIKE '%$keyword%' OR category='$category' ORDER BY job_id DESC limit $page1,3");}
  ...
  $sql = mysqli_query($conn,"SELECT * FROM all_jobs LEFT JOIN company ON all_jobs.customer_email=company.admin ORDER BY job_id DESC limit $page1,3");
}
?>
...
if($keyword==""){
  ...
  else{$sql=mysqli_query($conn,"select * from all_jobs LEFT JOIN company ON all_jobs.customer_email=company.admin WHERE keyword LIKE '%$keyword%' OR category='$category'");}
   $error=mysqli_num_rows($sql); 
