			          ...
			          <div class="col-md-12 tab-wrap">
			            ...
			            <div class="tab-content p-4" id="v-pills-tabContent">
			              ...
			              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
			              	<form action="index2.php" method="post" class="search-job">
			              		<div class="row">
			              			<div class="col-md">
            ...
            <div class="block-27">
              <ul>
                ...
                <?php
                  ...
                  $a=$count/3;
                  ceil($a); //ceil 向上舍入为最接近的整数
                  for ($b=1; $b <=$a ; $b++) {
                ?>
                <li><a href="index2.php?page=<?php echo $b;?>"><?php echo $b;?></a></li>
                <?php } ?> 
                <li><a href="#">&gt;</a></li>
              </ul>

              <form action="index2.php" method="post" class="search-job">
              <input type="page" value="<?php echo $b;?>" name="<?php echo $b;?>" id="page" class="form-control btn btn-primary">
              </form>
            </div>
          </div>
        </div>
