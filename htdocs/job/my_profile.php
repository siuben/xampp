...
<br>
   ...
   <div class="row">
        <div class="col-md-6">
        <img src="profile_img/<?php if(!empty($img)) {echo $img;} else {echo 'login_iconbbc.png';} ?>" class="img-thumbnail" alt="Cinque Terre">
        </div>
   ...
   <div class="row">
    ...
    <div class="col-md-6">
        <td><input type="text" name="name" id="name" value="<?php if(!empty($number)) echo $name; ?>" placeholder="Enter Your Name" class="form-group"></td>
    </div>
