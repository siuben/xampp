          ...
          <div style="width: 60%; margin-left: 20%; background-color: #F2F4F4">
            ...
            <form action="" method="post" style="margin:3%; padding: 3%;" name="customer_form" id="customer_form">
                <div class="form-group">
                    ...
                    <input type="Category" name="Category" id="Category" value="<?php echo $category; ?>" class="form-control" placeholder="Enter Company Name">
                </div>
                <div class="form-group">
                    ...
                    <input type="hidden" name="id" id="id" value="<?php echo $_GET['edit']; ?>">   <!--post id-->
                    <div class="form-group">
...
if(isset($_POST['submit'])){
    ...
    $query1=mysqli_query($conn,"update job_category set category='$category', des='$des'
    where id ='$id'");
    if ($query1) {
