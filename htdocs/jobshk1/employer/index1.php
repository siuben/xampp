<?php 
require_once 'controllers/employer_authController.php'; 
...
<div class="container">
	<div class="row">
		...
		<?php endif; ?> 
		  ...
		  未verified整另一個版 You need to vertify your account.
		  Sign in to your email account and click on the
		  vertification link we just emailed you at
		  <strong><?php echo $_SESSION['admin_email']; ?></strong>
		  </div>
		  <?php endif; ?>
