...
<h4><div style="margin-left: -40%">Work Experience</div></h4>
   ...
   <div class="row">
    ...
    <option value="<?php if(!empty($total_experience)) echo $total_experience; ?>"><?php if(!empty($total_experience)){ echo $total_experience;}else{echo "Please select";} ?></option>
   ...
   <div class="row">
    ...
    <select name="category" id="category" class="form-group">
                                  <option value="<?php if(!empty($category)) echo $category; ?>"><?php if(!empty($category)){echo $category;}else{echo "Category";} ?></option>
                                  <?php 
                                  include('connection/db.php');
...
<select name="education" id="education" class="form-group">
    <option value="<?php if(!empty($education)) echo $education; ?>"><?php if(!empty($education)){echo $education;}else{echo "Please select";} ?></option>
    <option value="Master's Degree">Master's Degree</option>
    <option value="Degree">Degree</option>
    <option value="Asso Deg / High Dip">Asso Deg / High Dip</option>
    <option value="Diploma">Diploma</option>
    <option value="F.5-F.7 or DSE">F.5-F.7 or DSE</option>
    <option value="Below F.5">Below F.5</option>
</select>
</div>
   </div>
   ...
   <div class="row">
    ...
    <option value="<?php if(!empty($expected_salary)) echo $expected_salary; ?>"><?php if(!empty($expected_salary)){echo $expected_salary;}else{echo "Please select";} ?></option>
    ...
    <option value="$100,000 or above">$100,000 or above</option>
</select>
    </div>
   </div>
