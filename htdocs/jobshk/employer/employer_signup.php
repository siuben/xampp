		...
		<div class="col-md-4 offset-md-4 form-div">
		  <form action="employer_signup.php" method="post">
			...
			<div class="form-group">
				...
				<input type="text" name="company" value="<?php echo $company; ?>" class="form-control form-control-lg">
			</div>
			<div class="form-group">
				<label for="full_name">Your full name</label>
				<input type="text" name="full_name" value="<?php echo $full_name; ?>" class="form-control form-control-lg">
			</div>
			<div class="form-group">
