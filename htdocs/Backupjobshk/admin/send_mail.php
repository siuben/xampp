...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="category.php">Send E-mail</a></li>
          ...
          <form action="phpmailer.php" method="post" style="border: 1px solid gray; width:60%; margin-left: 10px; padding: 10px;">
          ...
          while($row=mysqli_fetch_array($query)){
            ?>
                ...
                <div class="form-group">
                    ...
                    Dear <?php echo strtoupper($row['first_name']); ?><?php echo strtoupper($row['last_name']); ?></textarea></td>
                </div>
