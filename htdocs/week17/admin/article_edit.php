              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <select id="category" class="form-control">
                  <option value="最新消息" <?php echo ($data['category'] == "最新消息")?"checked":"";?>>最新消息</option>
                  <option value="心得" <?php echo ($data['category'] == "心得")?"checked":"";?>>心得</option>
                </select>
              </div>
              <div class="form-group">
    			...
    			if($("#title").val() == '' || $("#content").val() == ''){
    				...
    				$("div.loading").html('');
					  ...
					  //使用 ajax 送出 帳密給 verify_user.php
						$.ajax({
	            type : "POST",
	            url : "../php/update_article.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
	            data : {
	            	id : $("#id").val(), //使用者帳號
