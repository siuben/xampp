          ...
          <div class="col-xs-12">
            <form id="edit_work_form">
              ...
              <div class="form-group">
                ...
                <input type="hidden" id="video_path" value="<?php echo($data['video_path']) ? $data['video_path'] : ''; ?>">
                <div class="video">
                  <?php if($data['video_path'] && file_exists("../" . $data['video_path'])):?>
