...
class __TwigTemplate_1056bad9df1291c9abfea9f77887c3ef80a72cda96093ad5fd654fb8145241ec extends Template
{
    private $source;
    private $macros = [];
  ...
  <ul id=\"topmenu2\">
    <li>
      <a href=\"server_status.php";
        ...
        echo "\"";
        echo (((0 === twig_compare(($context["active"] ?? null), "status"))) ? (" class=\"tabactive\"") : (""));
        echo ">
        ";
        // line 5
    ...
    <li>
      <a href=\"server_status_processes.php";
        ...
        echo PhpMyAdmin\Url::getCommon();
        echo "\"";
        echo (((0 === twig_compare(($context["active"] ?? null), "processes"))) ? (" class=\"tabactive\"") : (""));
        echo ">
        ";
        // line 10
    ...
    <li>
      <a href=\"server_status_queries.php";
        ...
        echo PhpMyAdmin\Url::getCommon();
        echo "\"";
        echo (((0 === twig_compare(($context["active"] ?? null), "queries"))) ? (" class=\"tabactive\"") : (""));
        echo ">
        ";
        // line 15
    ...
    <li>
      <a href=\"server_status_variables.php";
        ...
        echo PhpMyAdmin\Url::getCommon();
        echo "\"";
        echo (((0 === twig_compare(($context["active"] ?? null), "variables"))) ? (" class=\"tabactive\"") : (""));
        echo ">
        ";
        // line 20
    ...
    <li>
      <a href=\"server_status_monitor.php";
        ...
        echo PhpMyAdmin\Url::getCommon();
        echo "\"";
        echo (((0 === twig_compare(($context["active"] ?? null), "monitor"))) ? (" class=\"tabactive\"") : (""));
        echo ">
        ";
        // line 25
    ...
    <li>
      <a href=\"server_status_advisor.php";
        ...
        echo PhpMyAdmin\Url::getCommon();
        echo "\"";
        echo (((0 === twig_compare(($context["active"] ?? null), "advisor"))) ? (" class=\"tabactive\"") : (""));
        echo ">
        ";
        // line 30
